import type { Comment, CommentStatus, CommentThread, CreateCommentInput } from './comment.js';
...
export interface UpdateTransportConfigRequest {
    active_transport: TransportType;
...
export interface GitScanParams {
    roots?: string;
    max_depth?: number;
}
