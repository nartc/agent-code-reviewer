    ...
    template: `
        <div class="card-body gap-1">
            ...
            <div class="flex items-center gap-2 text-xs">
                <ng-icon [name]="comment().author === 'agent' ? 'lucideBot' : 'lucideUser'" class="size-3" />
                <span
                    ...
                    @switch (comment().status) {
                        ...
                        @case ('sent') {
                            <button
                                ...
                                (click)="resolved.emit(comment().id)"
                            >
