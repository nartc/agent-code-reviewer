...
describe('DbService', () => {
  ...
  describe('query', () => {
    it('returns rows', () => {
      service.execute(
        "INSERT INTO repos (id, name) VALUES ('r1', 'repo1')"
      );
      service.execute(
        "INSERT INTO repos (id, name) VALUES ('r2', 'repo2')"
      );
      service.execute(
        "INSERT INTO repos (id, name) VALUES ('r3', 'repo3')"
      );

      const result = service.query<{ id: string; name: string }>(
  ...
  describe('queryOne', () => {
    it('returns single row', () => {
      service.execute(
        "INSERT INTO repos (id, name) VALUES ('r1', 'test')"
      );

      const result = service.queryOne<{ id: string; name: string }>(
        "SELECT * FROM repos WHERE id = $id",
        { $id: 'r1' }
      );
  ...
  describe('transaction', () => {
    it('commits on success', () => {
      ...
      const query = service.queryOne<{ id: string }>(
        "SELECT * FROM repos WHERE id = 'r1'"
      );
  ...
  describe('save', () => {
    it('exports valid DB to file', async () => {
      ...
      service.execute(
        "INSERT INTO repos (id, name) VALUES ('r1', 'saved-repo')"
      );
